  ...
  return (
    ...
    <div className= "mt-8 md:mt-16">
        ...
        <div className="md:hidden IMG mt-10 flex justify-center">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 mt-12 lg:mt-20 gap-4 xl:mx-40">

          <div className="left">

            <div className="top  ">
              <h1 className="text-5xl lg:text-4xl lg:text-start font-semibold sm:text-center p-1" >DOWNLOAD APP NOW</h1>
              <p className="mt-4 mx-4 lg:mx-0 text-[#6C6C72]" >Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra nunc ante velit vitae. Est tellus vitae, nullam lobortis enim. Faucibus amet etiam tincidunt rhoncus, ullamcorper velit. Ullamcorper risus tempor, ac nunc libero urna, feugiat.</p>

              <div className="imgs flex items-center  md:justify-center  lg:justify-start md:gap-4  gap-2 sm:gap-4 mt-10">
            ...
            <img src={app} alt="" />
             ...
             <div className="bottomcards gap-5 p-1 text-white justify-between flex mt-8 lg:mt-16">
              ...
              <div className="card1 h-[125px] w-[103px] sm:w-[137px] lg:h-[197px] rounded-xl lg:w-[200px] flex flex-col text-center justify-center items-center border border-[#5851EA] bg-[#5851EA]">
                <img src={dwnldic} alt=""  />
                <h1 className="mt-4 lg:text-xl">59865</h1>
                <h1 className="mt-4 text-sm lg:text-xl">DOWNLOAD</h1>
              </div>
              <div className="card1 h-[125px] w-[103px] sm:w-[137px] flex flex-col text-center justify-center items-center lg:h-[197px] rounded-xl lg:w-[200px] border border-[#5851EA] bg-[#5851EA]">
              <img src={thumb} alt=""  />
