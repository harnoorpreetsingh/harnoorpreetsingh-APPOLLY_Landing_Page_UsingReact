        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-8 lg:mt-20 xl:px-[120px]">
            ...
            <img src={p2} alt="" className="ml-1" />
             ...
             <div className="rightcards  mt-8 md:mt-2 ">
                ...
                <div className="card1 md:h-[150px] md:w-[368px] sm:h-[190px] xl:h-[220px] rounded-xl xl:w-[672px] shadow-lg  p-2 xl:p-8 ">
                ...
                <div className="card1 md:h-[150px] md:w-[368px] sm:h-[190px] xl:h-[220px] rounded-xl mt-8 xl:mt-4 xl:w-[672px] shadow-lg p-2 xl:p-8 ">
                ...
                <div className="card1 md:h-[150px] md:w-[368px] h-[125px] sm:h-[190px] xl:h-[220px] rounded-xl mt-8 xl:mt-4 xl:w-[672px]  p-2 xl:p-8 shadow-lg">
                    <div className="top flex gap-3 mt-1">
                        <img src={tick} alt=""  className="lg:w-[35px] mt-3"/>
