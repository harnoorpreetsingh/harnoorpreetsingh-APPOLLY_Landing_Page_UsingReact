  ...
  return (
    ...
    <div className="text mt-16 text-center">
        ...
        <div className="card grid grid-cols-1 justify-center md:grid-cols-3 mt-12 xl:mx-40 p-4 gap-10 md:justify-between">
            <div className="card flex flex-col items-center rounded-xl xl:h-[450px] xl:w-[390px]  p-1 shadow-2xl">
                  <img src={Image} alt=""  />
            ...
            <div className="card flex flex-col items-center xl:h-[450px] rounded-xl xl:w-[390px] p-1 shadow-2xl">
                  <img src={Image2} alt=""  />
                  <div className="text px-4">
